...
#define DISCONNECTING_LIONEL "Disconnecting Lionel...\n"
...
#define TEXT_LIST_FILE "Kulkan.txt"
#define FILES_LIST_STRUCTURE "%s %ld bytes\n"
...
typedef struct {
  ...
  FilesMessage fMessage;                  // Informació dels fitxers.
  ConstellationsMessage cMessage;         // Informació de les constel·lacions.
  Statistics statistics;                  // Resultat
} Message;
